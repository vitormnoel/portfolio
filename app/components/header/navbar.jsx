...
function navBar() {
  ...
  return (
    <div className="pt-8 pb-2 md:px-12 fixed top-0 right-0 left-0 z-10 w-full bg-white drop-shadow-sm dark:bg-neutral-800">
      <div className="flex place-content-between mx-auto px-8 container">
