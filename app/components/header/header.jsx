...
function headerSection() {
  return (
    <header className="flex flex-col justify-center h-[95vh] items-center text-center">
      <p className="text-8xl cursor-pointer">💻</p>
      <h2 className="capitalize text-4xl md:text-6xl pt-2 font-thin">Software Engineer</h2>
      <p className="md:w-2/3 pt-4 select-none">
        a Brazilian developer based in <span className="text-green-dark hover:underline underline-offset-4 font-medium">{location}</span>, experienced in Full Stack
